    ...
    >
      ...
      <div className="flex flex-col mb-2">
        ...
        <input
          type="text"
          className={clsx("p-2 border rounded-md bg-gray-200", {
            "border-red-800": errors.postalCode,
          })}
          autoFocus
      ...
      <div className="flex flex-col mb-2 sm:mt-2">
        <div className="inline-flex items-center mb-10">
          ...
          <span className="ml-2">recordar como dirección de facturación?</span>
        </div>
